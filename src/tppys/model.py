# https://huggingface.co/edugp/kenlm/raw/main/model.py
import os
import re
import unicodedata
...
class KenlmModel:
    ...
    def __init__(
        self,
        kenlm_bin_filepath: str,
        sp_model_filepath: str,
        lower_case: bool = False,
        remove_accents: bool = False,
        normalize_numbers: bool = True,
        punctuation: int = 1,
    ):
        self.model = kenlm.Model(kenlm_bin_filepath)
        self.tokenizer = SentencePiece(sp_model_filepath)
